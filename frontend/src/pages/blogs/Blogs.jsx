...
const Blogs = () => {
  return (
    <section class="section__container blog__container">
        ...
        <div
          class="md:p-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8"
        >
          <div
            class="blog__card cursor-pointer hover:scale-105 transition-all duration-200"
          >
            <img
